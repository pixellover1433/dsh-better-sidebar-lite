...
export function DockRoot({ useSessions, useWorkspaces, rpc, tabs, t, layout }) {
...
export function createDockEntry(services) {
    const DockEntry = (props) => (_jsx(DockRoot, { useSessions: props.useSessions, useWorkspaces: props.useWorkspaces, rpc: services.rpc, tabs: services.tabs, t: services.t, layout: services.layout }));
    return DockEntry;
}

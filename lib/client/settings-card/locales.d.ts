...
export type BetterSidebarPluginsLocaleKey = 'cardTitle' | 'cardDescription' | 'overridden' | 'reset' | 'readOnly' | 'expand' | 'collapse' | 'save' | 'saving' | 'discard' | 'unsaved' | 'saveFailed' | 'invalidNumber' | 'explorerPollMs' | 'explorerPollMsHint' | 'explorerDebounceMs' | 'explorerDebounceMsHint' | 'gitPollMs' | 'gitPollMsHint' | 'gitDebounceMs' | 'gitDebounceMsHint';

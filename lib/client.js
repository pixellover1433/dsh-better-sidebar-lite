...
var tablist_default = { "tabActive": "bsd-aZEaXa-tabActive", "label": "bsd-aZEaXa-label", "list": "bsd-aZEaXa-list", "tabInactive": "bsd-aZEaXa-tabInactive" };
...
var dock_default = { "rootFloating": "bsd-v2wPsa-rootFloating", "empty": "bsd-v2wPsa-empty", "body": "bsd-v2wPsa-body", "header": "bsd-v2wPsa-header", "title": "bsd-v2wPsa-title", "iconButton": "bsd-v2wPsa-iconButton", "root": "bsd-v2wPsa-root" };
...
function DockRoot({ useSessions, useWorkspaces, rpc, tabs, settings, t, layout }) {
...
var footer_toggle_default = { "rail": "bsd-KQo-TG-rail", "wide": "bsd-KQo-TG-wide", "label": "bsd-KQo-TG-label", "button": "bsd-KQo-TG-button" };
...
var ExplorerPanel_default = { "panel": "bsd-bZtlRa-panel", "surface": "bsd-bZtlRa-surface", "surfaceLoading": "bsd-bZtlRa-surfaceLoading", "surfaceTitle": "bsd-bZtlRa-surfaceTitle", "retry": "bsd-bZtlRa-retry", "name": "bsd-bZtlRa-name", "rowFocused": "bsd-bZtlRa-rowFocused", "inlineError": "bsd-bZtlRa-inlineError", "caretPlaceholder": "bsd-bZtlRa-caretPlaceholder", "icon": "bsd-bZtlRa-icon", "retryInline": "bsd-bZtlRa-retryInline", "title": "bsd-bZtlRa-title", "row": "bsd-bZtlRa-row", "symlinkTarget": "bsd-bZtlRa-symlinkTarget", "caret": "bsd-bZtlRa-caret", "tree": "bsd-bZtlRa-tree", "srOnly": "bsd-bZtlRa-srOnly", "panelHead": "bsd-bZtlRa-panelHead", "rowSelected": "bsd-bZtlRa-rowSelected", "refresh": "bsd-bZtlRa-refresh", "surfaceHint": "bsd-bZtlRa-surfaceHint" };
...
function useBetterSidebarSettings(scope) {
  const cached = (0, import_react4.useRef)({
    snapshot: void 0,
...
function ExplorerPanel({ rpc, emitter, t }) {
  ...
  const [store] = (0, import_react5.useState)(() => new ExplorerStore(
    (path, signal) => rpc.call(Endpoints.explorerList, { path }, { signal })
  ));
  const state = (0, import_react5.useSyncExternalStore)(store.subscribe.bind(store), store.snapshot.bind(store));
  const root = (0, import_react5.useMemo)(() => resolveRoot(sessions, workspaces), [sessions, workspaces]);
  const stampLoader = (0, import_react5.useCallback)(
    (request, signal) => rpc.call(Endpoints.explorerStamp, request, { signal }),
    [rpc]
  );
  const lastActivityRef = (0, import_react5.useRef)({ sessionId: void 0, updatedAt: 0 });
  const activitySeededRef = (0, import_react5.useRef)(false);
  const autoRefreshTimerRef = (0, import_react5.useRef)(null);
  const debounceMsRef = (0, import_react5.useRef)(explorerDebounceMs);
  debounceMsRef.current = explorerDebounceMs;
  const scheduleAutoRefresh = (0, import_react5.useCallback)(() => {
  ...
  const rowEls = (0, import_react5.useRef)(/* @__PURE__ */ new Map());
  (0, import_react5.useEffect)(() => {
...
function createExplorerTabDef(ctx, api) {
  ...
  return {
    ...
    order: 10,
    label: () => t("tabLabel"),
    icon: (0, import_react6.createElement)(FolderIcon),
    renderPanel: () => (0, import_react6.createElement)(ExplorerPanel, { rpc: api.rpc, emitter: api.emitter, t })
  };
}
...
var git_default = { "branchName": "bsd-3XgNyW-branchName", "conflictSection": "bsd-3XgNyW-conflictSection", "stateAction": "bsd-3XgNyW-stateAction", "sectionAction": "bsd-3XgNyW-sectionAction", "discardAllRow": "bsd-3XgNyW-discardAllRow", "stateTitle": "bsd-3XgNyW-stateTitle", "deleted": "bsd-3XgNyW-deleted", "discardAction": "bsd-3XgNyW-discardAction", "commitSubject": "bsd-3XgNyW-commitSubject", "backButton": "bsd-3XgNyW-backButton", "commitMessage": "bsd-3XgNyW-commitMessage", "section": "bsd-3XgNyW-section", "logSection": "bsd-3XgNyW-logSection", "glyph": "bsd-3XgNyW-glyph", "commitRow": "bsd-3XgNyW-commitRow", "renamed": "bsd-3XgNyW-renamed", "filePath": "bsd-3XgNyW-filePath", "retryButton": "bsd-3XgNyW-retryButton", "added": "bsd-3XgNyW-added", "sectionTitle": "bsd-3XgNyW-sectionTitle", "stateHint": "bsd-3XgNyW-stateHint", "modified": "bsd-3XgNyW-modified", "originalPath": "bsd-3XgNyW-originalPath", "composer": "bsd-3XgNyW-composer", "commitMeta": "bsd-3XgNyW-commitMeta", "header": "bsd-3XgNyW-header", "composerRow": "bsd-3XgNyW-composerRow", "iconButton": "bsd-3XgNyW-iconButton", "state": "bsd-3XgNyW-state", "rowAction": "bsd-3XgNyW-rowAction", "body": "bsd-3XgNyW-body", "fileStatus": "bsd-3XgNyW-fileStatus", "muted": "bsd-3XgNyW-muted", "commitHash": "bsd-3XgNyW-commitHash", "statusSections": "bsd-3XgNyW-statusSections", "discardAllButton": "bsd-3XgNyW-discardAllButton", "commitDetailHead": "bsd-3XgNyW-commitDetailHead", "fileDir": "bsd-3XgNyW-fileDir", "branch": "bsd-3XgNyW-branch", "logTitle": "bsd-3XgNyW-logTitle", "commitDate": "bsd-3XgNyW-commitDate", "panel": "bsd-3XgNyW-panel", "commits": "bsd-3XgNyW-commits", "commitButton": "bsd-3XgNyW-commitButton", "composerInput": "bsd-3XgNyW-composerInput", "row": "bsd-3XgNyW-row", "unmerged": "bsd-3XgNyW-unmerged", "untracked": "bsd-3XgNyW-untracked", "commitFileRow": "bsd-3XgNyW-commitFileRow", "sectionHeader": "bsd-3XgNyW-sectionHeader", "statePath": "bsd-3XgNyW-statePath", "rows": "bsd-3XgNyW-rows", "fileName": "bsd-3XgNyW-fileName", "empty": "bsd-3XgNyW-empty", "commitFiles": "bsd-3XgNyW-commitFiles", "loading": "bsd-3XgNyW-loading", "sectionCount": "bsd-3XgNyW-sectionCount", "commitAuthor": "bsd-3XgNyW-commitAuthor", "commitFilePath": "bsd-3XgNyW-commitFilePath", "loadMore": "bsd-3XgNyW-loadMore", "commitDetailTitle": "bsd-3XgNyW-commitDetailTitle", "rowActions": "bsd-3XgNyW-rowActions", "banner": "bsd-3XgNyW-banner", "commitDetail": "bsd-3XgNyW-commitDetail" };
...
function CommitComposer({ result, root, rpc, t, onCommitted, onActionError }) {
  ...
  const [includeAll, setIncludeAll] = (0, import_react7.useState)(false);
...
function GitTab({ rpc, t }) {
  ...
  const [statusValue, setStatusValue] = (0, import_react7.useState)(null);
  const [logValue, setLogValue] = (0, import_react7.useState)(null);
  const [statusError, setStatusError] = (0, import_react7.useState)(null);
  const [logError, setLogError] = (0, import_react7.useState)(null);
  const [actionError, setActionError] = (0, import_react7.useState)(null);
  const [selectedCommit, setSelectedCommit] = (0, import_react7.useState)(null);
  const [commitDetail, setCommitDetail] = (0, import_react7.useState)({ kind: "loading" });
  const commitDetailCtrl = (0, import_react7.useRef)(null);
  const [loading, setLoading] = (0, import_react7.useState)(true);
  const [logLimit, setLogLimit] = (0, import_react7.useState)(GIT_LOG_PAGE_SIZE);
  const logLimitRef = (0, import_react7.useRef)(logLimit);
  const setPage = (0, import_react7.useCallback)((next) => {
    logLimitRef.current = next;
    setLogLimit(next);
  }, []);
  const statusRef = (0, import_react7.useRef)(null);
  const applyStatus = (0, import_react7.useCallback)((next) => {
    statusRef.current = next;
    setStatusValue(next);
  }, []);
  const controllerRef = (0, import_react7.useRef)(null);
  const nextController = (0, import_react7.useCallback)(() => {
  ...
  const refreshStatus = (0, import_react7.useCallback)(() => {
    if (root === void 0) return;
    const ctrl = nextController();
    const signal = ctrl.signal;
    void (async () => {
  ...
  const discard = (0, import_react7.useCallback)(async (entry) => {
    if (root === void 0) return;
  ...
  const discardAll = (0, import_react7.useCallback)(async () => {
  ...
  const autoRefresh = (0, import_react7.useCallback)(() => {
    if (root === void 0 || document.hidden) return;
    const ctrl = nextController();
    const signal = ctrl.signal;
    void (async () => {
  ...
  const autoRefreshTimerRef = (0, import_react7.useRef)(null);
  const debounceMsRef = (0, import_react7.useRef)(gitDebounceMs);
  debounceMsRef.current = gitDebounceMs;
  const scheduleAutoRefresh = (0, import_react7.useCallback)(() => {
    if (autoRefreshTimerRef.current !== null) window.clearTimeout(autoRefreshTimerRef.current);
    autoRefreshTimerRef.current = window.setTimeout(() => {
      autoRefreshTimerRef.current = null;
      void autoRefresh();
  ...
  const lastActivityRef = (0, import_react7.useRef)({ sessionId: void 0, updatedAt: 0 });
  const activitySeededRef = (0, import_react7.useRef)(false);
  const openCommit = (0, import_react7.useCallback)((entry) => {
    if (root === void 0) return;
  ...
  const closeCommit = (0, import_react7.useCallback)(() => {
    commitDetailCtrl.current?.abort();
...
function createGitTabDef(ctx, api) {
  ...
  return {
    ...
    order: 20,
    label: () => t("tabLabel"),
    icon: (0, import_react8.createElement)(GitBranchIcon),
    renderPanel: () => (0, import_react8.createElement)(GitTab, { rpc: api.rpc, t })
  };
}
...
// bsd-css:./settings-card.module.css
var cssText6 = ".bsd-kpxpiq-card {\n  border: 1px solid var(--bsd-border, #80808040);\n  background: var(--bsd-bg-2, #8080800f);\n  border-radius: 6px;\n  margin: 0 0 8px;\n  list-style: none;\n}\n\n.bsd-kpxpiq-header {\n  cursor: pointer;\n  text-align: left;\n  width: 100%;\n  color: inherit;\n  background: none;\n  border: none;\n  justify-content: space-between;\n  align-items: center;\n  padding: 8px 12px;\n  display: flex;\n}\n\n.bsd-kpxpiq-headText {\n  flex-direction: column;\n  gap: 2px;\n  display: flex;\n}\n\n.bsd-kpxpiq-name {\n  font-weight: 600;\n}\n\n.bsd-kpxpiq-description {\n  opacity: .7;\n  font-size: 12px;\n}\n\n.bsd-kpxpiq-pending {\n  color: #c98000;\n  font-size: 12px;\n}\n\n.bsd-kpxpiq-body {\n  padding: 4px 12px 12px;\n}\n\n.bsd-kpxpiq-readOnly {\n  opacity: .7;\n  font-size: 12px;\n}\n\n.bsd-kpxpiq-field {\n  margin: 8px 0;\n}\n\n.bsd-kpxpiq-head {\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 4px;\n  display: flex;\n}\n\n.bsd-kpxpiq-label {\n  font-size: 13px;\n}\n\n.bsd-kpxpiq-badges {\n  align-items: center;\n  gap: 6px;\n  display: flex;\n}\n\n.bsd-kpxpiq-badge {\n  color: #c98000;\n  font-size: 11px;\n}\n\n.bsd-kpxpiq-reset, .bsd-kpxpiq-discard, .bsd-kpxpiq-save {\n  border: 1px solid var(--bsd-border, #80808040);\n  cursor: pointer;\n  color: inherit;\n  background: none;\n  border-radius: 4px;\n  padding: 2px 8px;\n  font-size: 12px;\n}\n\n.bsd-kpxpiq-reset:hover, .bsd-kpxpiq-discard:hover, .bsd-kpxpiq-save:hover {\n  opacity: .85;\n}\n\n.bsd-kpxpiq-reset:disabled, .bsd-kpxpiq-discard:disabled, .bsd-kpxpiq-save:disabled {\n  opacity: .5;\n  cursor: default;\n}\n\n.bsd-kpxpiq-input, .bsd-kpxpiq-inputInvalid {\n  box-sizing: border-box;\n  border: 1px solid var(--bsd-border, #80808040);\n  width: 100%;\n  color: inherit;\n  background: none;\n  border-radius: 4px;\n  padding: 4px 8px;\n  font-size: 13px;\n}\n\n.bsd-kpxpiq-inputInvalid {\n  border-color: #d33;\n}\n\n.bsd-kpxpiq-invalidText {\n  color: #d33;\n  margin: 4px 0 0;\n  font-size: 11px;\n}\n\n.bsd-kpxpiq-footer {\n  justify-content: flex-end;\n  gap: 8px;\n  margin-top: 8px;\n  display: flex;\n}\n\n.bsd-kpxpiq-failed {\n  color: #d33;\n  margin: 0 auto 0 0;\n  font-size: 12px;\n}\n";
var styleId6 = "bsd-css-d0958fb1";
...
var settings_card_default = { "card": "bsd-kpxpiq-card", "headText": "bsd-kpxpiq-headText", "reset": "bsd-kpxpiq-reset", "readOnly": "bsd-kpxpiq-readOnly", "inputInvalid": "bsd-kpxpiq-inputInvalid", "pending": "bsd-kpxpiq-pending", "save": "bsd-kpxpiq-save", "failed": "bsd-kpxpiq-failed", "discard": "bsd-kpxpiq-discard", "header": "bsd-kpxpiq-header", "field": "bsd-kpxpiq-field", "badge": "bsd-kpxpiq-badge", "footer": "bsd-kpxpiq-footer", "body": "bsd-kpxpiq-body", "head": "bsd-kpxpiq-head", "name": "bsd-kpxpiq-name", "label": "bsd-kpxpiq-label", "input": "bsd-kpxpiq-input", "invalidText": "bsd-kpxpiq-invalidText", "badges": "bsd-kpxpiq-badges", "description": "bsd-kpxpiq-description" };
...
function BetterSidebarSettingsCard(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("li", { className: settings_card_default.card, children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("button", { type: "button", className: settings_card_default.header, "aria-expanded": open, onClick: () => {
      setOpen(!open);
    }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("span", { className: settings_card_default.headText, children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: settings_card_default.name, children: fieldLabel("cardTitle") }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: settings_card_default.description, children: fieldLabel("cardDescription") })
      ] }),
      state.dirty ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: settings_card_default.pending, children: fieldLabel("unsaved") }) : null
    ] }),
    open ? /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: settings_card_default.body, children: [
      !state.writable ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { className: settings_card_default.readOnly, role: "status", children: fieldLabel("readOnly") }) : null,
      CARD_FIELDS.map((fieldKey) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        FieldControl,
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: settings_card_default.footer, children: [
        state.failed ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { className: settings_card_default.failed, role: "status", children: fieldLabel("saveFailed") }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("button", { type: "button", className: settings_card_default.discard, disabled: !state.dirty || state.saving, onClick: props.discard, children: fieldLabel("discard") }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("button", { type: "button", className: settings_card_default.save, disabled: blocked, onClick: props.save, children: fieldLabel(state.saving ? "saving" : "save") })
      ] })
    ] }) : null
  ] });
}
function FieldControl(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: settings_card_default.field, children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: settings_card_default.head, children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("label", { className: settings_card_default.label, htmlFor: id, children: fieldLabel(fieldKey) }),
      field?.overridden === true ? /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("span", { className: settings_card_default.badges, children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: settings_card_default.badge, children: fieldLabel("overridden") }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("button", { type: "button", className: settings_card_default.reset, disabled: props.disabled, onClick: () => resetField(fieldKey), children: fieldLabel("reset") })
      ] }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      ...
      {
        id,
        className: field?.invalid === true ? settings_card_default.inputInvalid : settings_card_default.input,
        type: "text",
        inputMode: "numeric",
        ...
        onChange: (event) => {
          edit(fieldKey, event.target.value);
        }
      }
    ),
    field?.invalid === true ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { className: settings_card_default.invalidText, children: fieldLabel("invalidNumber") }) : null
  ] });
}
...
function apply(ctx) {
  ...
  ctx.effect(() => {
    ...
    const DockEntry = createDockEntry({ rpc, tabs, settings: scope, t: ctx.locale.bind(NS3), layout: ctx.layout });

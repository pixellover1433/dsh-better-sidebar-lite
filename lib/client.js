...
var dock_default = { "header": "bsd-v2wPsa-header", "empty": "bsd-v2wPsa-empty", "rootFloating": "bsd-v2wPsa-rootFloating", "root": "bsd-v2wPsa-root", "title": "bsd-v2wPsa-title", "iconButton": "bsd-v2wPsa-iconButton", "body": "bsd-v2wPsa-body" };
...
var ExplorerPanel_default = { "symlinkTarget": "bsd-bZtlRa-symlinkTarget", "surface": "bsd-bZtlRa-surface", "rowFocused": "bsd-bZtlRa-rowFocused", "title": "bsd-bZtlRa-title", "row": "bsd-bZtlRa-row", "refresh": "bsd-bZtlRa-refresh", "caret": "bsd-bZtlRa-caret", "rowSelected": "bsd-bZtlRa-rowSelected", "surfaceHint": "bsd-bZtlRa-surfaceHint", "name": "bsd-bZtlRa-name", "panel": "bsd-bZtlRa-panel", "caretPlaceholder": "bsd-bZtlRa-caretPlaceholder", "surfaceTitle": "bsd-bZtlRa-surfaceTitle", "inlineError": "bsd-bZtlRa-inlineError", "surfaceLoading": "bsd-bZtlRa-surfaceLoading", "retry": "bsd-bZtlRa-retry", "tree": "bsd-bZtlRa-tree", "panelHead": "bsd-bZtlRa-panelHead", "icon": "bsd-bZtlRa-icon", "retryInline": "bsd-bZtlRa-retryInline", "srOnly": "bsd-bZtlRa-srOnly" };
...
var AUTO_REFRESH_EXPLORER_INTERVAL_MS = 8e3;
var AUTO_REFRESH_EXPLORER_DEBOUNCE_MS = 600;
...
function ExplorerPanel({ rpc, emitter, t }) {
  ...
  const stampLoader = (0, import_react4.useCallback)(
    (request, signal) => rpc.call(Endpoints.explorerStamp, request, { signal }),
    [rpc]
  );
  const lastActivityRef = (0, import_react4.useRef)({ sessionId: void 0, updatedAt: 0 });
  const activitySeededRef = (0, import_react4.useRef)(false);
  const autoRefreshTimerRef = (0, import_react4.useRef)(null);
  const scheduleAutoRefresh = (0, import_react4.useCallback)(() => {
...
var git_default = { "state": "bsd-3XgNyW-state", "statePath": "bsd-3XgNyW-statePath", "conflictSection": "bsd-3XgNyW-conflictSection", "originalPath": "bsd-3XgNyW-originalPath", "rows": "bsd-3XgNyW-rows", "retryButton": "bsd-3XgNyW-retryButton", "discardAllButton": "bsd-3XgNyW-discardAllButton", "branchName": "bsd-3XgNyW-branchName", "body": "bsd-3XgNyW-body", "sectionAction": "bsd-3XgNyW-sectionAction", "empty": "bsd-3XgNyW-empty", "section": "bsd-3XgNyW-section", "modified": "bsd-3XgNyW-modified", "rowAction": "bsd-3XgNyW-rowAction", "glyph": "bsd-3XgNyW-glyph", "commitRow": "bsd-3XgNyW-commitRow", "logTitle": "bsd-3XgNyW-logTitle", "commitDetailHead": "bsd-3XgNyW-commitDetailHead", "backButton": "bsd-3XgNyW-backButton", "added": "bsd-3XgNyW-added", "commitMeta": "bsd-3XgNyW-commitMeta", "commitDetailTitle": "bsd-3XgNyW-commitDetailTitle", "banner": "bsd-3XgNyW-banner", "commitFileRow": "bsd-3XgNyW-commitFileRow", "commitFilePath": "bsd-3XgNyW-commitFilePath", "discardAllRow": "bsd-3XgNyW-discardAllRow", "discardAction": "bsd-3XgNyW-discardAction", "composerRow": "bsd-3XgNyW-composerRow", "commits": "bsd-3XgNyW-commits", "composerInput": "bsd-3XgNyW-composerInput", "commitAuthor": "bsd-3XgNyW-commitAuthor", "panel": "bsd-3XgNyW-panel", "stateAction": "bsd-3XgNyW-stateAction", "deleted": "bsd-3XgNyW-deleted", "sectionHeader": "bsd-3XgNyW-sectionHeader", "stateHint": "bsd-3XgNyW-stateHint", "loadMore": "bsd-3XgNyW-loadMore", "commitDetail": "bsd-3XgNyW-commitDetail", "logSection": "bsd-3XgNyW-logSection", "statusSections": "bsd-3XgNyW-statusSections", "rowActions": "bsd-3XgNyW-rowActions", "commitMessage": "bsd-3XgNyW-commitMessage", "renamed": "bsd-3XgNyW-renamed", "fileName": "bsd-3XgNyW-fileName", "commitHash": "bsd-3XgNyW-commitHash", "composer": "bsd-3XgNyW-composer", "loading": "bsd-3XgNyW-loading", "unmerged": "bsd-3XgNyW-unmerged", "header": "bsd-3XgNyW-header", "commitButton": "bsd-3XgNyW-commitButton", "commitFiles": "bsd-3XgNyW-commitFiles", "branch": "bsd-3XgNyW-branch", "sectionCount": "bsd-3XgNyW-sectionCount", "commitSubject": "bsd-3XgNyW-commitSubject", "untracked": "bsd-3XgNyW-untracked", "stateTitle": "bsd-3XgNyW-stateTitle", "muted": "bsd-3XgNyW-muted", "filePath": "bsd-3XgNyW-filePath", "fileDir": "bsd-3XgNyW-fileDir", "commitDate": "bsd-3XgNyW-commitDate", "iconButton": "bsd-3XgNyW-iconButton", "sectionTitle": "bsd-3XgNyW-sectionTitle", "fileStatus": "bsd-3XgNyW-fileStatus", "row": "bsd-3XgNyW-row" };
